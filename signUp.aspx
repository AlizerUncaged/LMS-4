    ...
    <div class="row justify-content-center align-items-center h-100">
      <div class="col-12 col-lg-9 col-xl-7">
        ...
        <form>
              ...
              </div><p><asp:Label ID="messagelabel" runat="server" Text=""/></p>
              <div class="mt-1 pt-1 ">
               <center><asp:Button runat="server" class="btn btn-primary btn-lg" type="submit" text="Sign Up" OnClick="SignUp_Click" /></center>
              </div>
                <p class="small fw-bold mt-2 pt-1 mb-0">Already have an account? <a href="login.aspx"
